...
export function ExperienceSection() {
  return (
    <div className="w-full bg-gray-950 py-20 max-w-[1080px] mx-auto">
      <div className="container mx-auto px-4">
        <p className="text-secondary-500 text-center text-heading-6 leading-[140%] tracking-[0%]">
          Why Choose Us
        </p>
        <h2 className="text-heading-1 font-medium text-white text-center leading-[140%] tracking-[0%] mb-10">
