...
export function ResultsSection() {
  const testimonials = [
    {
      "id": 1,
      "quote": "Bruce is one of, if not the best, negotiator of television I've ever known. I have seen him on both sides of the negotiation and he has a unique ability to get an amazing amount of value for his clients while leaving the station with enough dignity to keep doing business with him even though they are selling to him at the lowest unit rate on the station. I'm still perplexed how he does it!",
      "author": "Brian Brandy",
